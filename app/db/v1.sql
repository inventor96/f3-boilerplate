...
DROP DATABASE IF EXISTS `f3_boilerplate`;
CREATE DATABASE `f3_boilerplate` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `f3_boilerplate`;
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `verified`, `password`, `timezone`) VALUES
(1,	'Admin',	'User',	'admin@f3-boilerplate.net',	0,	'$2y$12$N2FSdUzizyt6yIoGUtsZOu8p6uCN7BDj8rUY.KCdvvg1FeRQ6P7x2',	'America/Denver'),
(2,	'Regular',	'User',	'user@f3-boilerplate.net',	0,	'$2y$12$Ezf6QTtSVxqoltVOktImcOvkoCyAKzQBjqdFEXhd9Oq4Pzb.bgnbS',	'America/Denver');
...
INSERT INTO `user_roles_map` (`id`, `user_id`, `role_id`) VALUES
(1,	1,	1),
(2,	2,	2);
